...
def element_add_test():
    ...
    with tik_instance.for_range(0, 10, thread_num=aicore_num) as i0:
    # with tik_instance.for_range(0, aicore_num, thread_num=aicore_num) as i0:
        ...
        with tik_instance.for_range(0, 4) as i:
            with tik_instance.for_range(0, 2) as j:
                ...
                tik_instance.data_move(data_B[offset], data_a_exp, 0, 128, 128//16, 0, 128//16*3)
