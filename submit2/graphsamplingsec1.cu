...
__device__ int random_offset(int range, int cycle)
{
    ...
    // remove replication
    engine.discard(threadIdx.x * 4 + cycle);
...
int main(int argc, char **argv)
{
    ...
    int src_num = 232965;
    int sampling_count = 4; // modify this value in section 2 to 1000
    ...
    /*initialize graph storage & input/output buffers on GPU*/
    int *d_src_ids;
    ...
    /*execute GPU sampling kernel*/
    dim3 block_num(72, 1); // you can modify these values
